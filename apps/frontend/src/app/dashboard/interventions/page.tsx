...
interface Intervention {
  ...
  title: string;
  description: string;
  type: 'firewall_update' | 'security_patch' | 'threat_response' | 'compliance_audit';
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const mockInterventions: Intervention[] = [
        {
          id: 'int-001',
          title: 'Critical Firewall Firmware Update',
          description: 'Deploy critical security patches for Check Point and Palo Alto firewalls',
          type: 'security_patch',
          status: 'scheduled',
          priority: 'critical',
          requestedBy: 'System',
          ...
          affectedSystems: ['CP-FW-EDGE-01', 'PA-FW-DC-01', 'FORTI-GW-01'],
          createdAt: '2024-01-15T10:00:00Z',
          updatedAt: '2024-01-15T10:00:00Z',
        },
        {
          id: 'int-002',
          title: 'NAT Policy Configuration Update',
          description: 'Update NAT rules and VPN policies for new branch office',
          type: 'firewall_update',
          status: 'completed',
          priority: 'high',
          requestedBy: 'john.customer@techcorp.com',
          assignedTo: 'Network Security Expert',
          scheduledDate: '2024-01-14T18:00:00Z',
          completedDate: '2024-01-14T19:30:00Z',
          estimatedDuration: 60,
          actualDuration: 90,
          costSaved: 450,
          affectedSystems: ['ASA-FW-DMZ', 'NGFW-BRANCH-01'],
        ...
        },
        {
          ...
          description: 'Emergency response to ongoing DDoS attack detection',
          type: 'threat_response',
          status: 'in_progress',
          priority: 'critical',
          requestedBy: 'SOC Team',
          assignedTo: 'Incident Response Team',
          estimatedDuration: 240,
          affectedSystems: ['WAF-PROD-01', 'IPS-CORE-01', 'CP-FW-EDGE-01'],
        ...
        },
        {
          ...
          description: 'PCI-DSS compliance audit and security log review',
          type: 'compliance_audit',
          status: 'pending',
          priority: 'medium',
          requestedBy: 'Automated',
          estimatedDuration: 180,
          affectedSystems: ['SIEM-CENTRAL', 'DLP-GATEWAY', 'All Firewalls'],
